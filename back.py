...
SupervisedTypeCat = st.sidebar.selectbox("Select Supervised Classifier Categories",
                                         ...
                                         "Random Forest Classifier", "Naive Bayes Algorithm","Linear Regression"))
...
def get_SuperAlgo(SupervisedTypeCat, params):
    if SupervisedTypeCat == "K-Nearest Neighbor":
        ...
        clf = SVC(C =params["C"])
    elif SupervisedTypeCat == "Random Forest Classifier":
        ...
        # Wiil do it shortly
    elif SupervisedTypeCat == "Naive Bayes Algorithm":
        # Will do it shortly
    else:
        #Will do it shortly
    return clf
